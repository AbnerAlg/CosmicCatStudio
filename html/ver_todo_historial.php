...
<script>
    ...
    <main>
        <div class="contenedor-main">
            <h2 class="encabezado-canciones">Historial Completo</h2>
            <div class="lista-canciones grid-canciones" id="contenedor-historial">
                <!-- Aquí se cargarán las canciones del historial -->
            </div>
        </div>
    </main>
    ...
    <div class="reproductor-musica">
        <div class="info-cancion">
            ...
            <div class="detalles-cancion">
                <p class="titulo-cancion">Título de la canción</p>
        ...
        <script src="../js/verTodoHistorial.js"></script>
    </div>
