document.addEventListener('DOMContentLoaded', function() {
    ...
    async function cargarTodasCanciones() {
        const response = await fetch('../php5/obtener_todas_canciones.php');
        const canciones = await response.json();
        
        const contenedorCanciones = document.getElementById('contenedor-todas-canciones');
        contenedorCanciones.innerHTML = ''; // Limpia cualquier contenido previo
